        ...
        <div>
            ...
            <div className="search">
              ...
              <div className="col-lg-12">
                  ...
                  <Button onClick={onRefresh} className="btnReload" style={{height:'38px',color:'#fff',background:'linear-gradient(to right, #af730785, orange)'}}><i class="fas fa-sync-alt"></i></Button>
